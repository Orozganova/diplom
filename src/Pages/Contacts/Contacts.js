  ...
  return (
    <section className="Contacts">
      ...
      <div className="contact-details">
        <p>
          <strong className="contact-label">Address:</strong> Venera flower shop 56 , USE, Kyrgyzstan,Kazakhstan,Uzbekistan,State, Country
        </p>
        <p>
          <strong className="contact-label">Phone:</strong> +996 505 02 97 97
        </p>
        <p>
      ...
      <Link
            ...
            <Link
              to="https://www.linkedin.com/in/aorozganova/"
              target='_blank'
            ...
            <Link
             to="https://twitter.com/aorozganova"
              target='_blank'
